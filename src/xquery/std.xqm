...
(: declare functions :)
declare variable $std:add-attribute      as function()   := std:add-attribute#4;
declare variable $std:add-xml-base       as function()   := std:add-xml-base#4;
declare variable $std:count              as function()   := std:count#4;
declare variable $std:compare            as function()   := std:compare#4;
declare variable $std:delete             as function()   := std:delete#4;
declare variable $std:error              as function()   := std:error#4;
declare variable $std:filter             as function()   := std:filter#4;
declare variable $std:directory-list     as function()   := std:directory-list#4;
declare variable $std:escape-markup      as function()   := std:escape-markup#4;
declare variable $std:http-request       as function()   := ();
declare variable $std:identity           as function()   := std:identity#4;
declare variable $std:insert             as function()   := std:insert#4;
declare variable $std:label-elements     as function()   := std:label-elements#4;
declare variable $std:load               as function()   := std:load#4;
declare variable $std:make-absolute-uris as function()   := std:make-absolute-uris#4;
declare variable $std:namespace-rename   as function()   := std:namespace-rename#4;
declare variable $std:pack               as function()   := std:pack#4;
declare variable $std:parameters         as function()   := ();
declare variable $std:rename             as function()   := std:rename#4;
declare variable $std:replace            as function()   := std:replace#4;
declare variable $std:set-attributes     as function()   := std:set-attributes#4;
declare variable $std:sink               as function()   := std:sink#4;
declare variable $std:split-sequence     as function()   := std:split-sequence#4;
declare variable $std:store              as function()   := std:store#4;
declare variable $std:string-replace     as function()   := std:string-replace#4;
declare variable $std:unescape-markup    as function()   := std:unescape-markup#4;
declare variable $std:xinclude           as function()   := std:xinclude#4;
declare variable $std:wrap               as function()   := std:wrap#4;
declare variable $std:wrap-sequence      as function()   := std:wrap-sequence#4;
declare variable $std:unwrap             as function()   := std:unwrap#4;
declare variable $std:xslt               as function()   := std:xslt#4;
