...
(: -------------------------------------------------------------------------- :)
declare variable $const:error          := <error-list xmlns="http://www.w3.org/ns/xproc-error">
...
declare variable  $const:xprocxq-error := <error-list xmlns="http://xproc.net/xproc/error">
