...
(: -------------------------------------------------------------------------- :)
declare variable $const:error := ("resource:net/xproc/xprocxq/etc/error-list.xml");
declare variable  $const:xprocxq-error := ("resource:net/xproc/xprocxq/etc/xproc-error-list.xml");


(: -------------------------------------------------------------------------- :)
(: Step Definition lookup :)
(: -------------------------------------------------------------------------- :)
declare variable $const:ext-steps := ("resource:net/xproc/xprocxq/etc/pipeline-extension.xml")/p:library;
declare variable $const:std-steps := ("resource:net/xproc/xprocxq/etc/pipeline-standard.xml")/p:library;
declare variable $const:opt-steps := ("resource:net/xproc/xprocxq/etc/pipeline-optional.xml")/p:library;
declare variable $const:comp-steps := ("resource:net/xproc/xprocxq/etc/xproc-component.xml")/xproc:components;
